...
class CourseMode(models.Model):
    ...
    currency = models.CharField(default=u"inr", max_length=8)
    ...
    sku = models.CharField(
        ...
        null=True,
        blank=True,
        verbose_name=u"Product ID",
        help_text="Enter the Paddle product ID here to retrieve the currency and price based on the user's location.",
    )
    ...
    # Added by developer
    @classmethod
    def get_product_id(cls, course_id):
        """
        Returns the product id for given course else None
        """
        try:
    ...
    def get_course_price_and_currency(cls, course_id, country_code, ip_address=""):
        ...
        If there is no price found, will return the default price 0 and currency INR
        """
        strike_price = 0
        try:
